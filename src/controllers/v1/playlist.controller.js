...
const getPlaylistById = asyncHandler(async (req, res) => {
  ...
  const playlist = await Playlist.findOne({
    ...
    .select(
      `${PLAYLIST_FIELDS.PLAYLIST_NAME} ${PLAYLIST_FIELDS.DESCRIPTION} ${PLAYLIST_FIELDS.THUMBNAIL} ${PLAYLIST_FIELDS.SONGS} ${PLAYLIST_FIELDS.OWNER} ${PLAYLIST_FIELDS.IS_PUBLIC}`
    )
    .populate({
